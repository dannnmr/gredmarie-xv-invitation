export const invitationConfig = {
  ...
  itinerary: [
    { time: '19:00', title: 'Bienvenida', description: 'Recepción inicial.', image: '/itinerario/image copy.png' },
    { time: '19:30', title: 'Recepción Social', description: 'Hora de llegada!.', image: '/itinerario/image.png' },
    { time: '21:00', title: 'Ceremonia', description: 'Ceremonia principal.', image: '/decoration/flor_blanca.png' },
    { time: '21:40', title: 'Sesión de Fotos', description: 'Capturando recuerdos.', image: '/itinerario/camara.png' },
    { time: '22:00', title: 'Cena', description: 'Disfrutemos juntos.', image: '/itinerario/comida.png' },
    { time: '22:30', title: '¡Todos a la pista!', description: 'A bailar.', image: '/decoration/bola disco.png' },
    { time: '23:30', title: 'Hora Loca', description: 'Fiesta temática.', image: '/itinerario/fiesta.png' },
    { time: '00:00', title: 'Torta', description: 'Momento dulce.', image: '/itinerario/torta2.png' },
    { time: '03:00', title: 'Hasta pronto', description: 'Gracias por acompañarnos.', image: '/decoration/hasta_luego.png' },
  ],
  dressCode: {
