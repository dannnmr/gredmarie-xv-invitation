...
export function FooterSection() {
  ...
  return (
    <footer className="relative flex flex-col items-center justify-center w-full py-8 px-6 bg-theme-primary overflow-hidden border-t border-theme-gold/10">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-theme-primary/80 to-black pointer-events-none z-0"></div>
      ...
      <div className="relative z-10 w-full max-w-[900px] flex flex-col md:flex-row items-center justify-between gap-10 text-center md:text-left">
        ...
        >
          ...
          <div className="flex flex-col text-left min-w-0">
            ...
            <span className="font-sans text-base font-black text-white uppercase mt-1 tracking-[0.02em] group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-white/60 transition-colors">
              Daniela Miranda
            </span>
            <span className="font-sans text-[0.7rem] font-medium text-white/70 mt-1">
